...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset004_Hemorrhage/nnUNetTrainerUMambaEnc__nnUNetPlans__3d_fullres'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_final.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset004_Hemorrhage/imagesTs'),
                                 join(nnUNet_raw, 'Dataset004_Hemorrhage/imagesTs_predlowres'),
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset004_Hemorrhage/imagesTr/1_0000.nii.gz')])
